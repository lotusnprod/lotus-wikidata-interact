...
data class Quad(
    ...
    override fun hashCode(): Int {
        return listOf(database.id, organism.id, compound.id, reference.id).hashCode()
    }
}

data class DataTotal(
    val quads: MutableSet<Quad> = mutableSetOf(),
...
fun loadGoldData(limit: Int? = null): DataTotal = loadData(GOLD_PATH, limit)

fun loadData(filename: String, limit: Int? = null): DataTotal {
    val logger = LogManager.getLogger("net.nprod.onpdb.goldcleaner.loadData")
